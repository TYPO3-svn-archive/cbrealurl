 ...
 * @version $Id: realurl.php,v 1.13 2008/12/10 11:07:09 cannon Exp $
 */
...
elseif ( false )
{
	$TYPO3_CONF_VARS['EXTCONF']['realurl']['www.cannonbose.com'] = $TYPO3_CONF_VARS['EXTCONF']['realurl']['_DEFAULT'];
	$TYPO3_CONF_VARS['EXTCONF']['realurl']['www.cannonbose.com']['pagePath']['rootpage_id'] = 1;
	$TYPO3_CONF_VARS['EXTCONF']['realurl']['cannonbose.com'] = $TYPO3_CONF_VARS['EXTCONF']['realurl']['www.cannonbose.com'];
	$TYPO3_CONF_VARS['EXTCONF']['realurl']['support.cannonbose.com'] = $TYPO3_CONF_VARS['EXTCONF']['realurl']['_DEFAULT'];
	$TYPO3_CONF_VARS['EXTCONF']['realurl']['support.cannonbose.com']['pagePath']['rootpage_id'] = 7;
}
